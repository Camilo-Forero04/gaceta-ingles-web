              ...
              <body style="margin: 0; padding: 0; background-color: #f9fafb; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
                <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 40px 20px; border-radius: 8px; color: #1f2937; line-height: 1.6;">
                  ...
                  <div style="text-align: center; margin: 40px 0;">
                      ...
                      <a href="https://t.me/+KYLO9Y4YUohkNGQ5" 
                         style="background-color: #0ea5e9; color: white; padding: 18px 35px; text-decoration: none; border-radius: 50px; font-weight: bold; font-size: 18px; display: inline-block; box-shadow: 0 4px 10px rgba(14, 165, 233, 0.3);">
                          👉 ENTRAR AL GRUPO VIP
                      </a>
                  ...
                  <div style="background-color: #EEF2FF; padding: 25px; border-radius: 12px; margin: 30px 0; border: 1px solid #e0e7ff;">
                    ...
                    <ul style="padding-left: 20px; margin: 0; list-style-type: circle; color: #374151;">
                      <li style="margin-bottom: 10px;"><strong>Producto:</strong> eBook "Desbloquea tu Fluidez" (Preventa)</li>
                      <li style="margin-bottom: 10px;"><strong>Bonus:</strong> Acceso al Speaking Challenge (Entregado arriba 👆)</li>
                      <li><strong>Entrega del eBook:</strong> 15 de Diciembre, 2025 <br><span style="font-size: 13px; color: #6b7280;">(Te llegará el enlace de descarga aquí mismo)</span>.</li>
                    </ul>
                  </div>
